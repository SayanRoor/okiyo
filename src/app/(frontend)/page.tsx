...
export default async function HomePage() {
  ...
  // автоматически снимаем префикс. Регулярка ловит:
  //  — «OKIYO» слитно
  //  — «O K I Y O» с пробелами между буквами (старый паттерн брендмарка)
  //  — любой регистр
  //  — необязательный разделитель после (— : · пробел)
  // Также чистим возможные двойные пробелы внутри title после среза.
