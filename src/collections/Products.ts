        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                description:
                  "Снимите галочку, чтобы пометить модель как «ПРОДАНО». Карточка не пропадёт из каталога — фото станет приглушённым, появится плашка SOLD OUT, цена будет зачёркнута. На странице товара кнопка «Заказать в WhatsApp» заменится на «Сообщить о поступлении». Это premium-паттерн: модельный ряд остаётся виден, но клиент чувствует, что часть моделей разбирают.",
              },
            },
          ],
        },
