        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                description:
                  "Фото только оправы со снятыми линзами на прозрачном фоне (PNG). Идеально: вид строго анфас, ширина 1200–1800px. Это изображение накладывается на лицо пользователя при включении камеры. Если поле пусто, кнопка примерки скрыта.",
              },
            },
            {
              name: "gallery",
